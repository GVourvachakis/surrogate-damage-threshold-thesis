...
\begin{table}[htbp]
    ...
    \small
    \input{tables/ch4/surrogate/linear_sampled_variables.tex}
\end{table}
...
\begin{table}[htbp]
    ...
    \small
    \input{tables/ch4/surrogate/nonlinear_20k_model_metrics.tex}
\end{table}
