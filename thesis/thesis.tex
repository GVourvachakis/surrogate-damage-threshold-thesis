...
%	tagging		= on, % For tagging (accessible PDF), run lualatex with TeX Live 2025 or later.
					  % Do not include appendices containing listings when selecting this option (listings package is not compatible).
...
%% Package retained for optional code listings.
...
\newcommand{\PublicFigureOmitted}[1][0.78\linewidth]{%
  \fbox{\parbox{#1}{\centering\small
  Figure omitted from public source because redistribution rights for the
  original third-party/adapted asset are not included. See
  \texttt{docs/ASSET\_PROVENANCE.md}.}}%
}
\newcommand{\PublicExternalValuesOmitted}[1][0.78\linewidth]{%
  \fbox{\parbox{#1}{\centering\small
  External PLAN-hub comparison values omitted from public source pending
...
\hypersetup{%
	pdfsubject={MSc thesis in Materials Science \& Engineering},
	% Change this to briefly state topic of your thesis 
% 
	pdfkeywords={University of Crete, UoC, Materials Science, Surrogate Modelling, Damage Threshold Estimation, Ultrashort Laser-Metal Interactions, Two-Temperature Model},
...
\newcommand{\fourln}{4\ln 2}    % Gaussian pulse-shape constant
...
%
\Author{Georgios S. Vourvachakis}{Department of Materials Science \& Engineering}
...
\Degree{Master of Science in Materials Science \& Engineering}{Department of Materials Science \& Engineering}

% If there is more than one supervisor, use the \Supervisor command for each.
% NB: department field added with v1.21 in late 2025. It is used ONLY on the Thesis Committee page.
%
\Supervisor{Yannis Pantazis}{Principal Researcher at IACM-FORTH}[IACM-FORTH]
...
%
% \Acceptor{<Official UoC Graduate Officer Name>}{<Official UoC Department Title>}{Graduate Officer, Department of Materials Science \& Engineering}
...
% Valid degree months are February, May, June, July, or September
\DegreeDate{July}{2026}


% Date that final thesis is submitted to department
\ThesisDate{July 13, 2026}

% If at least one thesis reader is included, a committee members page will be automatically generated.
% The local mitthesis class version in this environment does not define \Reader.
% Leave committee-member declarations disabled until the front matter is updated
% to the supported interface for this class release.
...
% \includeonly{acknowledgments,chapter1,chapter2,...,appendixa,...}
...
\vspace*{\fill}
\begin{center}
	\textbf{Dedicated to my cat, Lola.}

	\vspace{1.5em}

	Thank you for your constant presence, your unexpected comfort, and for helping quieten my racing thoughts. I am sorry I could not be there at the end.
\end{center}
\vspace*{\fill}
\cleardoublepage
...
\appendix
\include{appendices/appendixa}% IMEX-ARK2 derivation
\include{appendices/appendixb}% equilibration and ablation-threshold search
\include{appendices/appendixc}% sampling-support diagnostics for Chapter 4

\include{appendices/appendixd}% interference-intensity derivation
\include{appendices/appendixe}% axisymmetric Hankel formulation for the linear pTTM
\include{appendices/appendixf}% rectangular energy estimates for the dimensionless pTTM
